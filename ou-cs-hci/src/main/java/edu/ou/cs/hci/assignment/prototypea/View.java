		   ...
		   ListSelectionListener
{
	...
	public View(Controller controller)
	{
		...
		//create a progress bar for the media player
		//create a pane for the controls and media libraries
		Panel controlPanel = new Panel();
		controlPanel.add(Box.createHorizontalGlue());
		controlPanel.setLayout(new BorderLayout());
		controlPanel.add(createComboBox(),BorderLayout.NORTH);
		...
		//create a pane for the playlist and search box
		Panel playlist = new Panel();
		playlist.setLayout(new BorderLayout());
		
		playlist.add(new JButton("Open Media"),BorderLayout.CENTER);
		playlist.add(createTextArea(),BorderLayout.NORTH);

		// Create a split pane to allow adjustment of left versus right...
		JSplitPane	splitPanel = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				true);

		splitPanel.setResizeWeight(0.10);	// ...with default 10% for the left

		splitPanel.setLeftComponent(controlPanel);	
		splitPanel.setRightComponent(playlist);
	...
	{
		/*jjjjj	strollButton.removeActionListener(this);
...
*/// Should disable AbstractActions in toolbar buttons too...
	...
	public void	update(String key, Object value)
	{
		...
		*/	}
		...
		// Like the above  but invisible
		private JPanel		createUntitledPanel(JComponent c)
		{
			JPanel	p = new JPanel();
		...
		*/
		...
		{
		label = 			label.setBackground(Color.YELLOW);	// See comment below!
		...
		*/
		...
		private JPanel	createProgressBar()
		{
			...
			return createUntitledPanel(progressBar);
		}
		...
		// Create a search bar for the media section
		private JPanel	createTextArea()
		{

			textArea = new JTextArea(1,10);	// Set number of rows and columns
			textArea.addCaretListener(this);

			Box searchBox = new Box(BoxLayout.Y_AXIS);			//create a pane for the search bar
			searchBox.add(textArea);
			searchBox.add(new JLabel(
						Resources.getImage("example/swing/icon/search.png")));
			...
			sp.add(textArea,BorderLayout.EAST);
			sp.add(new JLabel("Playlist"),BorderLayout.WEST);
			return sp; 
		}
		...
		private JPanel	createToolBar()
		{
			...
			return createTitledPanel(toolBar, "Controls");
		}
